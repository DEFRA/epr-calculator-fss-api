namespace EPR.Calculator.FSS.API.Common.Result;
...
public class Result
{
    public Result(bool isSuccess, string errorMessage, HttpStatusCode statusCode)
    {
        IsSuccess = isSuccess;
        ErrorMessage = errorMessage;
        StatusCode = statusCode;
    ...
    public static Result FailedResult(string errorMessage, HttpStatusCode statusCode) 
